...
> Continuing the multi-stage attack chain from [Part 1](../soc-wazuh-lab-part1/README.md) — web application probing, privileged command abuse, persistence techniques, a simulated data exfiltration, and how all six stages tie together into a single investigation.

**Series:** Part 2 of 2 — see [Part 1](../soc-wazuh-lab-part1/README.md) for lab architecture, telemetry validation, reconnaissance detection, and SSH brute-force detection.
...
Part 1 covered the first half of this attack chain: building the lab, validating telemetry, and detecting reconnaissance and SSH brute-force. On their own, those two stages are relatively low-stakes — a scan and some failed logins.
...
*Originally published on [Medium](https://medium.com/@madebyabder/building-a-soc-from-scratch-web-attacks-persistence-and-exfiltration-with-wazuh-part-2-410e81fc8ebe). Cross-posted here as part of my cybersecurity portfolio. See [Part 1](../soc-wazuh-lab-part1/README.md) for the first half of this project.*
